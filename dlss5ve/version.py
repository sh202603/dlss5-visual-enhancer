...
counts CLI/engine revisions on top of that release in the third (10.0.0 is the
first package built on Visual Enhancer v10.0, which was called DLSS 5 Visual
...
release string; the About view of the app shortens it to "v10".
"""
